  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      {open && (
        <div
          role="listbox"
          className="absolute left-0 top-[calc(100%+6px)] z-30 max-h-64 w-full min-w-[10rem] overflow-y-auto rounded-xl border border-white/10 bg-elevated shadow-2xl shadow-black/50"
        >
