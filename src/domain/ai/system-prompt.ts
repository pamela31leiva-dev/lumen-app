...
- "familiar" si el texto menciona explicitamente al conyuge, hijos, "la familia", o un gasto compartido del hogar -- incluye gastos cotidianos y no solo medicos/escolares (ej. "desayuno con mi hijo" es Familiar, no Personal, aunque sea solo un desayuno). Otro ejemplo: "transporte cita medica de mi hijo" es Familiar Y Salud a la vez; en un caso asi usa "familiar" como carpeta principal, salud queda implicito en la descripcion.
