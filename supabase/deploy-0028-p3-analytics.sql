-- Aplica solo la migracion 0028. Pega esto en el SQL Editor de Supabase y
-- dale Run. Crea budgets (presupuesto mensual por categoria), las funciones
-- get_financial_history (activos/pasivos/patrimonio neto mes a mes) y
-- get_monthly_report (ingresos/gastos/categoria vs presupuesto), y un indice
-- de rendimiento para transferencias. Idempotente.
